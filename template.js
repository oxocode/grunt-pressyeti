/**
 * grunt-pressyeti
 * https://github.com/oxocode/pressyeti
 *
 * Copyright (c) 2014 Courtney Ivey (originally by Eric Mann, 10up)
...
exports.description = 'Create a Foundation-ready WordPress theme.';
...
exports.template = function( grunt, init, done ) {
	init.process( {}, [
		...
		init.prompt( 'title', 'PressYeti' ),
		{
			name   : 'prefix',
			message: 'PHP function prefix (alpha and underscore characters only)',
			default: 'pressyeti'
		},
		init.prompt( 'description', 'The best Foundation-ready WordPress theme ever made!' ),
